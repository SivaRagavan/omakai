...
## What is Tunedmodel
Tunedmodel is an opinionated, full-stack framework that helps developers build fine-tuned language models without having to wire up a training pipeline, inference infrastructure, or an app experience manually.

## What is a Tunedmodel Project?
A Tunedmodel Project is a locally trained language model that ships with a completely customizable chat experience, ready to run locally or deploy.
...
## Installation (Elixir)
Tunedmodel is built with Elixir.

- Install Elixir (1.19+) and Erlang/OTP (26+).
- Install Hex (usually comes with Elixir) via `mix local.hex`.
